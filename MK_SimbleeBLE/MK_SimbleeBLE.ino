...
const int datapin = 3; // whatever our data pin ends up being, make it this number
...
void setup()
{
  for (int i=2; i<12; i++)
  {
    //set all pins (currently 2 through 11) to digital output pins to use 
    pinMode(i, OUTPUT);
  }
  ...
  SimbleeBLE.txPowerLevel = 0;  // (-20dbM to +4 dBm)
